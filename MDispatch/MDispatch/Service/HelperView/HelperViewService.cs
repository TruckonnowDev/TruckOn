...
{
    public class HelperViewService : IHelperViewService
    {
        ...
        public void CallError(string info)
        {
        ...
        private void UnHidden(Layout layout)
        {
            layout.TranslateTo(0, 0);
        }

        public async void Hidden()
        {
            if (StackLayout != null
                && StackLayout.Children.ToList().FirstOrDefault(l => l.AutomationId == "la") != null
                && IsAddAlert)
        ...
        public void InitAlert(FlexLayout flexLayout)
        {
            StackLayout = null;
            FlexLayout = null;
        ...
        public void InitAlert(StackLayout stackLayout)
        {
            StackLayout = null;
            FlexLayout = null;
